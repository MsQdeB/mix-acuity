...
export default {
	App: {
		General: 'Tổng thể',
		Home: 'Trang chủ',
		MyFeeds: 'Feed của tôi',
		Subscriptions: 'Trang đăng ký',
		Interactions: 'Tương tác',
		BrowsingHistory: 'Lịch sử trình duyệt',
		Downloads: 'Tải về',
		PublishItem: 'Đăng mục',
		GotoItem: 'Đi đến mục',
		Account: 'Tài khoản',
		TransactionHistory: 'Lịch sử giao dịch',
		Profile: 'Hồ sơ',
		TrustedAccounts: 'Tài khoản tin cậy',
		Wallet: 'Ví tiền',
		Tokens: 'Tokens',
    ...
    AccountType: 'Loại tài khoản',
		...
		Location: 'Địa điểm',
		Feeds: 'Feeds',
		TrustedThatTrust: 'Bạn của người mình tin tưởng',
		Trusts: 'Người tin tưởng',
